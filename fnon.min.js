...
!(function (e, t) {
  ...
  function (e) {
    ...
    function b(e, t) {
      return t && "object" === _typeof(t) ? { ...e, ...t } : e;
    }
    var k = function (e, t) {
    ...
    function _(e, t) {
      var n =
        ...
        a = '<div class="f__cm" style="--f-f:'
          .concat(e.fontFamily, ";--m-bg:")
          .concat(e.background, ";z-index:")
          ...
          .concat(
            "" == e.title
              ...
              : '<div class="f__m__h" style="background:'
                  ...
                  .concat(
                    e.closeButton
                      ? '<button type="button" data-al="true" data-evt="ccl" class="cls"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>'
                      : "",
                    "</div>"
                  ),
            '<div class="f__m__b">'
          ...
          .concat(e.delButtons ? "" : r, "</div></div>");
      if (((a = g(a)), "alert" != t)) {
        var i = a.querySelectorAll('[data-evt="ccl"]');
        i &&
              ...
              ? n.addEventListener("click", function () {
                  if (
                    ...
                    var t = e.cancelCallback(function () {
                      T(a);
                    }, a.querySelector("div.f__m__b__ask"));
                    (null != t && !0 !== t) || T(a);
                  } else T(a);
                })
              : n.addEventListener("click", function () {
        ...
        var o = a.querySelector('[data-evt="tr"]');
        o &&
          o.addEventListener("click", function () {
            if (e.callback && "function" == typeof e.callback)
              if ("dialogue" == t) {
                ...
                (null != n && !0 !== n) || T(a);
              } else e.callback(!0), T(a);
            else T(a);
          });
      } else {
        var c = a.querySelectorAll('[data-al="true"]');
        Array.from(c).forEach(function (t) {
          t.addEventListener("click", function () {
            e.callback && "function" == typeof e.callback && e.callback(), T(a);
          });
        });
      }
      return (
        e.beforeShow && "function" == typeof e.beforeShow && e.beforeShow(a),
        document.body.classList.add("f__of_hidden"),
        document.body.appendChild(a),
        e.afterShow && "function" == typeof e.afterShow && e.afterShow(a),
        a
      );
    }
    var M = {
    ...
    Object.keys(w).forEach(function (e) {
      return (S[e] = function (t, n, r, a, i, o) {
        if (t && "" != t) {
          var c = { ...C, ...w[e] };
          t && "object" === _typeof(t)
            ? (c = { ...c, ...t })
    ...
    Object.keys(P).forEach(function (e) {
      return (j[e] = function (t, n) {
        var r = n ? { ...O, ...n } : O;
        (p = v(r.svgColor, 9)),
          (function (e, t, n) {
            if (document.getElementById(O.cid))
              k(
                "Waiting Existed!",
                "Waiting box is already existed. you need to call Change function instead."
              );
            else {
              var r = t && "object" === _typeof(t) ? { ...O, ...t } : O,
                a = "<div id="
                  .concat(O.cid, ' class="f f__cw" style="background:')
      ...
      (j.Change = function (e) {
        var t = document.getElementById(O.cid);
        if (t) {
          ...
          if (n) e ? (n.innerHTML = e) : n.remove();
            ...
            ((n = g(
              '<p style="font-size:'
                .concat(O.textSize, ";color:")
                .concat(O.textColor, '"></p>')
            )).innerHTML = e),
    ...
    return (
          ...
          (p = v(a.svgColor, 9)),
            (function (e, t, n, r) {
              ...
              if (a) {
                ...
                var i = n && "object" === _typeof(n) ? { ...E, ...n } : E,
                  o = '<div data-id="'
                    .concat(E.cid, '" class="f f__cb" style="background:')
                    .concat(
                      i.background,
                      '"><div class="f__w"><div style="width:'
                    )
                    .concat(i.svgSize.w, ";height:")
                    .concat(i.svgSize.h, ';">')
                    .concat(r, "</div>")
                    .concat(
                      t
      ...
      (R.Remove = function (e, t) {
        var n =
          "object" === _typeof(e)
            ? e.querySelector('div[data-id="'.concat(E.cid, '"]'))
            : "string" == typeof e
            ? document.querySelector(e + ' div[data-id="'.concat(E.cid, '"]'))
            : null;
        if (n) {
      ...
      { Ask: M, Alert: A, Dialogue: S, Hint: z, Wait: j, Box: R }
    );
  }
);
